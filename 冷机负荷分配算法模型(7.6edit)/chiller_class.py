...
if __name__ == "__main__":
    ...
    # for i in ['dech02']:
        ...
        a.Max_Q_train(start_time='2023-03-01 00:00:00', end_time='2023-07-09 23:59:59')
        ...
        try:
            ...
            print('{}的mape是{}'.format(i, str(mape)))
        except Exception as e:
            print('计算{}的mape时发生异常:{}'.format(i, str(e)))
        # print(dech01的mape是0.04025351343624178)
        # print(dech02的mape是0.8320075196251075)
        # print(dech03的mape是0.10167579148744864)
#
#
#
#
# X = a.Max_Q_get_data(start_time='2023-06-11 00:00:00',end_time='2023-06-11 23:59:59')[0]
# Y = a.Max_Q_get_data(start_time='2023-06-11 00:00:00',end_time='2023-06-11 23:59:59')[1]
# a.Max_Q_train(start_time='2023-02-01 00:00:00',end_time='2023-06-10 23:59:59')
# Result = a.Max_Q_predict(X)
# mape = mape_sklearn(Y,Result)
# print('Max_Q——mape:{:.4f}'.format(mape))
#
# X = a.power_get_data(start_time='2023-06-01 00:00:00',end_time='2023-06-13 23:59:59')[0]
# Y = a.power_get_data(start_time='2023-06-01 00:00:00',end_time='2023-06-13 23:59:59')[1]
# a.power_train(start_time='2023-02-01 00:00:00',end_time='2023-05-31 23:59:59')
# Result = a.power_predict(X)
# mape = mape_sklearn(Y,Result)
# print('power——mape:{:.4f}'.format(mape))
# print('---Record---')
# print('6.11 power——mape:0.0179')
# print('6.11-6.13 power——mape:0.0192')
# print('6.1-6.13 power——mape:0.0181')
# plt.plot(Y,label ="Actual")
# plt.plot(Result,label ="Predicted")
# plt.title("6.1-6.13 Power")
# plt.legend()
# plt.xticks([])
# plt.show()
#
#
# X = a.Min_set_out_temp_get_data(start_time='2023-06-11 00:00:00',end_time='2023-06-11 23:59:59')[0]
# # 因为Max_Q模型未定 此处预测不准确 故不用mape进行验证
# Y = a.Min_set_out_temp_get_data(start_time='2023-06-11 00:00:00',end_time='2023-06-11 23:59:59')[1]
# Result = a.Min_set_out_temp_calculate(X,a.Max_Q_predict(a.Max_Q_get_data(start_time='2023-06-11 00:00:00',end_time='2023-06-11 23:59:59')[0]),0)
# print(Result.min(), Result.max())
# Result = a.Min_set_out_temp_calculate(X,3000,0)
# print(Result.min(), Result.max())
# Result = a.Min_set_out_temp_calculate(X,2000,0)
# print(Result.min(), Result.max())
# Result = a.Min_set_out_temp_calculate(X,1000,0)
# print(Result.min(), Result.max())
# Result = a.Min_set_out_temp_calculate(X,500,0)
# print(Result.min(), Result.max())
#
#
# X = a.Q_get_data(start_time='2023-06-11 00:00:00',end_time='2023-06-11 23:59:59')
# Result = a.Q_calculate(X)
# print(Result)